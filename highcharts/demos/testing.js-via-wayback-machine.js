...
var UNDEFINED,
	...
	SVG_NS = 'http://wayback.archive.org/web/20121214090435/http://www.w3.org/2000/svg',
	...
	//wayback.archive.org/web/20121214090435/https://TRACKER_FILL = 'rgba(192,192,192,0.5)',
	NORMAL_STATE = '',
	HOVER_STATE = 'hover',
	SELECT_STATE = 'select',
...
function erase(arr, item) {
	...
	//wayback.archive.org/web/20121214090435/https://return arr;
}
...
function numberFormat(number, decimals, decPoint, thousandsSep) {
	var lang = defaultOptions.lang,
		// http://wayback.archive.org/web/20121214090435/http://kevin.vanzonneveld.net/techblog/article/javascript_equivalent_for_phps_number_format/
		n = number,
		c = decimals === -1 ?
			getDecimals(number) :
...
/**
 * Based on http://wayback.archive.org/web/20121214090435/http://www.php.net/manual/en/function.strftime.php
 * @param {String} format
	...
	init: function (elem, fromD, toD) {
		...
		if (start.length) {
			...
			while (start.length < endLength) {
				...
				//wayback.archive.org/web/20121214090435/https://bezier && sixify(start);
...
(function ($) {
	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		 ...
		 */
		map: function (arr, fn) {
			//wayback.archive.org/web/20121214090435/https://return jQuery.map(arr, fn);
			var results = [],
				i = 0,
				len = arr.length;
			for (; i < len; i++) {
		...
		removeEvent: function (el, eventType, handler) {
			...
			// http://wayback.archive.org/web/20121214090435/http://forum.jQuery.com/topic/javascript-error-when-unbinding-a-custom-event-using-jQuery-1-4-2
...
defaultOptions = {
	...
	global: {
		useUTC: true,
		canvasToolsURL: 'http://wayback.archive.org/web/20121214090435/http://code.highcharts.com/2.3.3/modules/canvas-tools.js',
		VMLRadialGradientURL: 'http://wayback.archive.org/web/20121214090435/http://code.highcharts.com/2.3.3/gfx/vml-radial-gradient.png'
	},
	chart: {
		//wayback.archive.org/web/20121214090435/https://animation: true,
		//wayback.archive.org/web/20121214090435/https://alignTicks: false,
		//wayback.archive.org/web/20121214090435/https://reflow: true,
		//wayback.archive.org/web/20121214090435/https://className: null,
		//wayback.archive.org/web/20121214090435/https://events: { load, selection },
		//wayback.archive.org/web/20121214090435/https://margin: [null],
		//wayback.archive.org/web/20121214090435/https://marginTop: null,
		//wayback.archive.org/web/20121214090435/https://marginRight: null,
		//wayback.archive.org/web/20121214090435/https://marginBottom: null,
		//wayback.archive.org/web/20121214090435/https://marginLeft: null,
		borderColor: '#4572A7',
		//wayback.archive.org/web/20121214090435/https://borderWidth: 0,
		borderRadius: 5,
		defaultSeriesType: 'line',
		ignoreHiddenSeries: true,
		//wayback.archive.org/web/20121214090435/https://inverted: false,
		//wayback.archive.org/web/20121214090435/https://shadow: false,
		spacingTop: 10,
		spacingRight: 10,
		spacingBottom: 15,
		spacingLeft: 10,
		...
		//wayback.archive.org/web/20121214090435/https://plotBackgroundColor: null,
		plotBorderColor: '#C0C0C0',
		//wayback.archive.org/web/20121214090435/https://plotBorderWidth: 0,
		//wayback.archive.org/web/20121214090435/https://plotShadow: false,
		//wayback.archive.org/web/20121214090435/https://zoomType: ''
		resetZoomButton: {
			theme: {
				zIndex: 20
			},
			position: {
				align: 'right',
				x: -10,
				//wayback.archive.org/web/20121214090435/https://verticalAlign: 'top',
				y: 10
			}
			// relativeTo: 'plot'
		}
	...
	plotOptions: {
		line: { // base series options
			...
			//wayback.archive.org/web/20121214090435/https://connectNulls: false,
			//wayback.archive.org/web/20121214090435/https://cursor: 'default',
			//wayback.archive.org/web/20121214090435/https://clip: true,
			//wayback.archive.org/web/20121214090435/https://dashStyle: null,
			//wayback.archive.org/web/20121214090435/https://enableMouseTracking: true,
			events: {},
			//wayback.archive.org/web/20121214090435/https://legendIndex: 0,
			lineWidth: 2,
			shadow: true,
			// stacking: null,
			marker: {
				enabled: true,
				//wayback.archive.org/web/20121214090435/https://symbol: null,
				lineWidth: 0,
				radius: 4,
				lineColor: '#FFFFFF',
				//wayback.archive.org/web/20121214090435/https://fillColor: null,
				states: { // states for a single point
					hover: {
						enabled: true
						//wayback.archive.org/web/20121214090435/https://radius: base + 2
					},
					select: {
						fillColor: '#FFFFFF',
						lineColor: '#000000',
			...
			pointRange: 0,
			//wayback.archive.org/web/20121214090435/https://pointStart: 0,
			//wayback.archive.org/web/20121214090435/https://pointInterval: 1,
			showInLegend: true,
			states: { // states for the entire series
				hover: {
					//wayback.archive.org/web/20121214090435/https://enabled: false,
					//wayback.archive.org/web/20121214090435/https://lineWidth: base + 1,
					marker: {
						// lineWidth: base + 1,
						// radius: base + 1
					}
			...
			stickyTracking: true
			//wayback.archive.org/web/20121214090435/https://tooltip: {
				//wayback.archive.org/web/20121214090435/https://pointFormat: '<span style="color:{series.color}">{series.name}</span>: <b>{point.y}</b>'
				//wayback.archive.org/web/20121214090435/https://valueDecimals: null,
				//wayback.archive.org/web/20121214090435/https://xDateFormat: '%A, %b %e, %Y',
				//wayback.archive.org/web/20121214090435/https://valuePrefix: '',
				//wayback.archive.org/web/20121214090435/https://ySuffix: ''				
			//}
			// turboThreshold: 1000
			// zIndex: null
		}
	...
	labels: {
		//wayback.archive.org/web/20121214090435/https://items: [],
		style: {
			//wayback.archive.org/web/20121214090435/https://font: defaultFont,
			position: ABSOLUTE,
			color: '#3E576F'
		}
	},
	legend: {
		enabled: true,
		align: 'center',
		//wayback.archive.org/web/20121214090435/https://floating: false,
		layout: 'horizontal',
		...
		itemHoverStyle: {
			//wayback.archive.org/web/20121214090435/https://cursor: 'pointer', removed as of #601
			color: '#000'
		},
		itemHiddenStyle: {
			color: '#CCC'
	...
	tooltip: {
		enabled: true,
		//wayback.archive.org/web/20121214090435/https://crosshairs: null,
		...
		//wayback.archive.org/web/20121214090435/https://formatter: defaultFormatter,
		...
		//wayback.archive.org/web/20121214090435/https://valueDecimals: null,
		//wayback.archive.org/web/20121214090435/https://valuePrefix: '',
		//wayback.archive.org/web/20121214090435/https://valueSuffix: ''
	},

	credits: {
		enabled: true,
		text: 'Highcharts.com',
		href: 'http://wayback.archive.org/web/20121214090435/http://www.highcharts.com',
		position: {
			align: 'right',
			x: -10,
			verticalAlign: 'bottom',
			...
			for (key in hash) {
				...
				if (result !== false) {
					...
					if (key === 'd') {
						...
						//wayback.archive.org/web/20121214090435/https://wrapper.d = value; // shortcut for animations
					...
					// Chrome/Win < 6 bug (http://wayback.archive.org/web/20121214090435/http://code.google.com/p/chromium/issues/detail?id=15461)
			...
			if (currentTextTransform !== wrapper.cTT) { // do the calculations and DOM access only if properties changed
				...
				if (defined(rotation)) {
					...
					if (renderer.isSVG) { // #916
						...
						// Test case: http://wayback.archive.org/web/20121214090435/http://highcharts.com/tests/?file=text-rotation
...
SVGRenderer.prototype = {
	...
	image: function (src, x, y, width, height) {
		...
		if (elemWrapper.element.setAttributeNS) {
			elemWrapper.element.setAttributeNS('http://wayback.archive.org/web/20121214090435/http://www.w3.org/1999/xlink',
				'href', src);
		} else {
	...
	fontMetrics: function (fontSize) {
		...
		// Applies to the default font family. http://wayback.archive.org/web/20121214090435/http://jsfiddle.net/highcharts/7xvn7/
...
if (useCanVG) {
	...
	CanVGRenderer = function () {
		...
		SVG_NS = 'http://wayback.archive.org/web/20121214090435/http://www.w3.org/1999/xhtml';
	};
...
Axis.prototype = {
	...
	defaultOptions: {
		...
		lineColor: '#C0D0E0',
		lineWidth: 1,
		//wayback.archive.org/web/20121214090435/https://linkedTo: null,
		//wayback.archive.org/web/20121214090435/https://max: undefined,
		//wayback.archive.org/web/20121214090435/https://min: undefined,
		minPadding: 0.01,
		maxPadding: 0.01,
		//wayback.archive.org/web/20121214090435/https://minRange: null,
		minorGridLineColor: '#E0E0E0',
		// minorGridLineDashStyle: null,
		minorGridLineWidth: 1,
		minorTickColor: '#A0A0A0',
		//wayback.archive.org/web/20121214090435/https://minorTickInterval: null,
		minorTickLength: 2,
		minorTickPosition: 'outside', // inside or outside
		//wayback.archive.org/web/20121214090435/https://minorTickWidth: 0,
		//wayback.archive.org/web/20121214090435/https://opposite: false,
		//wayback.archive.org/web/20121214090435/https://offset: 0,
		//wayback.archive.org/web/20121214090435/https://plotBands: [{
		//	events: {},
		//	zIndex: 1,
		//	labels: { align, x, verticalAlign, y, style, rotation, textAlign }
		//}],
		//wayback.archive.org/web/20121214090435/https://plotLines: [{
		//	events: {}
		//  dashStyle: {}
		//	zIndex:
		//	labels: { align, x, verticalAlign, y, style, rotation, textAlign }
		//}],
		//wayback.archive.org/web/20121214090435/https://reversed: false,
		// showFirstLabel: true,
		// showLastLabel: true,
		startOfWeek: 1,
		startOnTick: false,
		tickColor: '#C0D0E0',
		//wayback.archive.org/web/20121214090435/https://tickInterval: null,
		tickLength: 5,
		...
		tickWidth: 1,
		title: {
			//wayback.archive.org/web/20121214090435/https://text: null,
			align: 'middle', // low, middle or high
			//wayback.archive.org/web/20121214090435/https://margin: 0 for horizontal, 10 for vertical axes,
			//wayback.archive.org/web/20121214090435/https://rotation: 0,
			//wayback.archive.org/web/20121214090435/https://side: 'outside',
			style: {
				color: '#6D869F',
				//wayback.archive.org/web/20121214090435/https://font: defaultFont.replace('normal', 'bold')
				fontWeight: 'bold'
			}
			//wayback.archive.org/web/20121214090435/https://x: 0,
			//wayback.archive.org/web/20121214090435/https://y: 0
		},
	...
	defaultYAxisOptions: {
		...
		stackLabels: {
			enabled: false,
			//wayback.archive.org/web/20121214090435/https://align: dynamic,
			//wayback.archive.org/web/20121214090435/https://y: dynamic,
			//wayback.archive.org/web/20121214090435/https://x: dynamic,
			//wayback.archive.org/web/20121214090435/https://verticalAlign: dynamic,
			//wayback.archive.org/web/20121214090435/https://textAlign: dynamic,
			//wayback.archive.org/web/20121214090435/https://rotation: 0,
			formatter: function () {
				return this.total;
			},
	...
	init: function (chart, userOptions) {
		...
		//wayback.archive.org/web/20121214090435/https://axis.axisTitleMargin = UNDEFINED,// = options.title.margin,
		axis.minPixelPadding = 0;
		//wayback.archive.org/web/20121214090435/https://axis.ignoreMinPadding = UNDEFINED; // can be set to true by a column or bar series
		//wayback.archive.org/web/20121214090435/https://axis.ignoreMaxPadding = UNDEFINED;
		...
		// Elements
		//wayback.archive.org/web/20121214090435/https://axis.axisGroup = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://axis.gridGroup = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://axis.axisTitle = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://axis.axisLine = UNDEFINED;
		...
		// Linked axis.
		//wayback.archive.org/web/20121214090435/https://axis.linkedParent = UNDEFINED;
	
		// Flag if type === datetime
		axis.isDatetimeAxis = isDatetimeAxis;
	
		// Flag if percentage mode
		//wayback.archive.org/web/20121214090435/https://axis.usePercentage = UNDEFINED;
	
		
		// Tick positions
		//wayback.archive.org/web/20121214090435/https://axis.tickPositions = UNDEFINED; // array containing predefined positions
		// Tick intervals
		//wayback.archive.org/web/20121214090435/https://axis.tickInterval = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://axis.minorTickInterval = UNDEFINED;
		...
		// Minor ticks
		axis.minorTicks = {};
		//wayback.archive.org/web/20121214090435/https://axis.tickAmount = UNDEFINED;
		...
		// Axis metrics
		//wayback.archive.org/web/20121214090435/https://axis.left = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://axis.top = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://axis.width = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://axis.height = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://axis.bottom = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://axis.right = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://axis.transA = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://axis.transB = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://axis.oldTransA = UNDEFINED;
		axis.len = 0;
		//wayback.archive.org/web/20121214090435/https://axis.oldMin = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://axis.oldMax = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://axis.oldUserMin = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://axis.oldUserMax = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://axis.oldAxisLength = UNDEFINED;
		...
		//wayback.archive.org/web/20121214090435/https://axis.dataMin = UNDEFINED,
		//wayback.archive.org/web/20121214090435/https://axis.dataMax = UNDEFINED,
		...
		//wayback.archive.org/web/20121214090435/https://axis.userMin = UNDEFINED,
		//wayback.archive.org/web/20121214090435/https://axis.userMax = UNDEFINED,
		...
		each(axis.series, function (series) {
			...
			if (series.visible || !chart.options.chart.ignoreHiddenSeries) {
				...
				// Get dataMin and dataMax for Y axes, as well as handle stacking and processed data
					...
					//wayback.archive.org/web/20121214090435/https://findPointRange = series.pointRange === null;
	...
	setAxisTranslation: function () {
		...
		//wayback.archive.org/web/20121214090435/https://axis.translationSlope = axis.transA = transA = axis.len / ((range + (2 * minPointOffset)) || 1);
	...
	setScale: function () {
		...
		axis.setAxisSize();
		//wayback.archive.org/web/20121214090435/https://axisLength = horiz ? axisWidth : axisHeight;
...
function Tooltip(chart, options) {
	...
	//wayback.archive.org/web/20121214090435/https://this.currentSeries = UNDEFINED;
...
function MouseTracker(chart, options) {
	...
	// The interval id
	//wayback.archive.org/web/20121214090435/https://this.tooltipTimeout = UNDEFINED;

	// The cached x hover position
	//wayback.archive.org/web/20121214090435/https://this.hoverX = UNDEFINED;

	// The chart position
	//wayback.archive.org/web/20121214090435/https://this.chartPosition = UNDEFINED;

	// The selection marker element
	//wayback.archive.org/web/20121214090435/https://this.selectionMarker = UNDEFINED;

	// False or a value > 0 if a dragging operation
	//wayback.archive.org/web/20121214090435/https://this.mouseDownX = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.mouseDownY = UNDEFINED;
...
Legend.prototype = {
	...
	init: function (chart) {
		...
		var //wayback.archive.org/web/20121214090435/https://style = options.style || {}, // deprecated
		...
		legend.chart = chart;
		//wayback.archive.org/web/20121214090435/https://legend.allItems = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://legend.legendWidth = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://legend.legendHeight = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://legend.offsetWidth = UNDEFINED;
		legend.itemHeight = 0;
		legend.lastLineHeight = 0;
		//wayback.archive.org/web/20121214090435/https://legend.itemX = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://legend.itemY = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://legend.lastItemY = UNDEFINED;
	
		// Elements
		//wayback.archive.org/web/20121214090435/https://legend.group = UNDEFINED;
		//wayback.archive.org/web/20121214090435/https://legend.box = UNDEFINED;
...
function Chart(userOptions, callback) {
	...
	this.isResizing = 0;
	this.options = options;
	//wayback.archive.org/web/20121214090435/https://chartTitleOptions = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://chartSubtitleOptions = UNDEFINED;

	this.axes = [];
	this.series = [];
	this.hasCartesianSeries = optionsChart.showAxes;
	//wayback.archive.org/web/20121214090435/https://this.axisOffset = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.maxTicks = UNDEFINED; // handle the greatest amount of ticks on grouped axes
	//wayback.archive.org/web/20121214090435/https://this.inverted = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.loadingShown = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.container = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.chartWidth = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.chartHeight = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.marginRight = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.marginBottom = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.containerWidth = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.containerHeight = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.oldChartWidth = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.oldChartHeight = UNDEFINED;

	//wayback.archive.org/web/20121214090435/https://this.renderTo = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.renderToClone = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.tracker = UNDEFINED;

	//wayback.archive.org/web/20121214090435/https://this.spacingBox = UNDEFINED

	//wayback.archive.org/web/20121214090435/https://this.legend = UNDEFINED;

	// Elements
	//wayback.archive.org/web/20121214090435/https://this.chartBackground = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.plotBackground = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.plotBGImage = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.plotBorder = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.loadingDiv = UNDEFINED;
	//wayback.archive.org/web/20121214090435/https://this.loadingSpan = UNDEFINED;
...
Series.prototype = {
	...
	translate: function () {
		...
		for (i = 0; i < dataLength; i++) {
			...
			//wayback.archive.org/web/20121214090435/https://point.plotX = mathRound(xAxis.translate(xValue, 0, 0, 0, 1) * 10) / 10; // Math.round fixes #591
			...
			each(points, function (point) {
				...
				// in the point options, or if they fall outside the plot area.
					...
					// create new label
						...
						attr = {
							//wayback.archive.org/web/20121214090435/https://align: align,
							fill: options.backgroundColor,
							stroke: options.borderColor,
...
defaultPlotOptions.column = merge(defaultSeriesOptions, {
	...
	borderWidth: 1,
	borderRadius: 0,
	//wayback.archive.org/web/20121214090435/https://colorByPoint: undefined,
	groupPadding: 0.2,
	//wayback.archive.org/web/20121214090435/https://grouping: true,
	marker: null, // point options are specified in the base options
	pointPadding: 0.1,
	//wayback.archive.org/web/20121214090435/https://pointWidth: null,
	minPointLength: 0,
...
defaultPlotOptions.pie = merge(defaultSeriesOptions, {
	...
	//wayback.archive.org/web/20121214090435/https://innerSize: 0,
	legendType: 'point',
	marker: null, // point options are specified in the base options
	size: '75%',
	showInLegend: false,
...
var PiePoint = extendClass(Point, {
	...
	init: function () {
		...
		//wayback.archive.org/web/20121214090435/https://visible: options.visible !== false,
		extend(point, {
...
/*
     FILE ARCHIVED ON 09:04:35 Dec 14, 2012 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 15:32:11 May 11, 2017.
